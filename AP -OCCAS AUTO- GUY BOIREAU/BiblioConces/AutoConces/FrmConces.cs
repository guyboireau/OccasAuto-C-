...
namespace AutoConces
{
    public partial class FrmConces : Form
    {
        ...
        private void btnenvoyer_Click(object sender, EventArgs e)
        {
            ...
            string txt = Connexion.RemoveSpecialCharacters(txtaff.Text);
            ...
            string req = "select * from concessionaire";
        ...
        {//affichage
            ...
            string req1 = "select max(idConces) from concessionaire";
            MySqlCommand cmd0 = new MySqlCommand(req1, cnx);
            int lastid = Convert.ToInt32(cmd0.ExecuteScalar());
           
            string req2 = string.Format("insert into concessionaire values(@id , @nom , @prenom, @adresse, @cp, @ville);");
        ...
        {//suppresion
            ...
            string req2 = "Delete from concessionaire where idConces = @id;";    
